...
module.exports = {
  ...
  site: {
    title: 'Hello, Im Jon Rutishauser',
    email: 'jrutishauser@gmail.com',
    description: "Things Ive been working on and my random thoughts",
    baseurl: '', // the subpath of your site, e.g. /blog
    url: 'http://ihavealongname.com',
  },
  // Where things are.
  ...
  file: {
    ...
    defaults: [
      ...
      },
      {
        // Any file in this path will have the default values applied.
        scope: { path: './about' },
        values: { template: 'page_text', permalink: '/:title/' },
      },
      {
        // Any file in this path will have the default values applied.
        scope: { path: './work' },
        values: { template: 'work', permalink: '/:title/' },
      },
      {
        // Any file in this path will have the default values applied.
        scope: { path: './contact' },
        values: { template: 'social', permalink: '/:title/' },
      },
      {
        // Any file in this path will have the default values applied.
        scope: { path: './hausbrewer' },
        values: { template: 'hausbrewer', permalink: '/:title/' },
      },
      {
        // Any file in this path will have the default values applied.
        scope: { path: './susannabot' },
        values: { template: 'susannabot', permalink: '/:title/' },
      },
      {
        // Any file in this path will have the default values applied.
        scope: { path: './colorclock' },
        values: { template: 'colorclock', permalink: '/:title/' },
      },
      {
        // Any file in this path will have the default values applied.
